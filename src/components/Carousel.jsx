    ...
    <div className="col-md-10">
        <div className="carousel slide" data-bs-ride="carousel" id="mycarousel">
            <div className="carousel-inner">
                ...
                <img src="images/ca1.jpg" alt="" className="d-block w-100" height="300px"/>
                </div>
 
                <div className="carousel-item">
                <img src="images/cupcake1.jpg" alt="" className="d-block w-100" height="300px"/>
                </div>
 
                <div className="carousel-item">
                <img src="images/steak1.jpg" alt="" className="d-block w-100" height="300px"/>
                </div>
